...
from .archs.vgg_arch import VGGFeatureExtractor, VGGFeatureExtractor_per
...
class PerceptualLoss(nn.Module):
    ...
    def __init__(self, feature_layer=[2,7,16,25,34], weights=[0.1,0.1,1.0,1.0,1.0], lossfn_type='l1', use_input_norm=True, use_range_norm=False):
        ...
        self.vgg = VGGFeatureExtractor_per(feature_layer=feature_layer, use_input_norm=use_input_norm, use_range_norm=use_range_norm)
